...
{weather_context}{progress_context}{community_context}
...
7. If other users have logged this same issue recently (noted above), briefly mention
   it's been going around locally — otherwise skip this point.
